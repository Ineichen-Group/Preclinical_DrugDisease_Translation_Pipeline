...
OUTPUT_FILE="${DATA_DIR}mapped_to_embeddings_ontologies/preclinical_chunks/update_2025/${ENTITY_TYPE}_mapped_preclinical_${ENTITY_TYPE}_enriched_${CHUNK_ID}.csv"
LINKING_STATS_DIR="nen_stats/preclinical_disease/update_2025/chunk_${CHUNK_ID}/"
...
echo "${ENTITY_TYPE},chunk_${CHUNK_ID},${DURATION}" \
    >> "timing_logs/${ENTITY_TYPE}_timing_update_2025.csv"
