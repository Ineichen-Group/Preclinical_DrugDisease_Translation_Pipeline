...
ENTITY_TYPE="disease"
COL_TO_MAP="linkbert_aact_mapped_conditions" #"linkbert_mapped_conditions" 

CHUNK_ID=$SLURM_ARRAY_TASK_ID
DATA_DIR="/shares/animalwelfare.crs.uzh/Preclinical_Pipeline/04_normalization/data/"
INPUT_FILE="${DATA_DIR}mapped_to_embeddings_ontologies/clinical/drug_mapped_clinical_drug_enriched.csv"
#preclinical: "${DATA_DIR}mapped_to_dict/chunks/dict_mapped_ner_chunk_${CHUNK_ID}.csv
OUTPUT_FILE="${DATA_DIR}mapped_to_embeddings_ontologies/drug_disease_mapped_clinical_drug_enriched.csv"
#preclinical: "$${DATA_DIR}mapped_to_embeddings_ontologies/dict_mapped_ner_chunk_${CHUNK_ID}.csv
