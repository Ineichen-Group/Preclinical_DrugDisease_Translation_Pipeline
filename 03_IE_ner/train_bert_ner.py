...
def main():
    ...
    decoded_preds = [
        ...
        for pred_seq, label_seq in zip(predictions, test_results.label_ids)
    ]

    # Save to JSONL or plain text
    with open(f"{training_args.output_dir}/predictions.json", "w") as f:
        json.dump(decoded_preds, f, indent=2)
