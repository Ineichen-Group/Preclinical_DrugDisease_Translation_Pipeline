...
#SBATCH --output=preclin_ner_age_inference_%j.out
#SBATCH --error=preclin_ner_age_inference_%j.err
...
INPUT_CSV="/scratch/sdonev/Preclinical_Pipeline/08_IE_full_text/model_predictions/age/age_sentences_filtered_20250721.csv" #"./data/regex_age_sentences.csv"

# Output CSV will be created with an additional "predicted_label" column
OUTPUT_CSV="./model_predictions/age/sentences_with_bert_age_predictions_20250721.csv"
