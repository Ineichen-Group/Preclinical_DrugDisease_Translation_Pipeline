...
FILE_PRECLINICAL_LINKING = "04_normalization/data/mapped_all/entities_drug_disease_preclin.csv"
FILE_CLINICAL_LINKING = "04_normalization/data/mapped_all/entities_drug_disease_clin.csv"
...
plot_top_entities_side_by_side(preclinical_df, id_column='PMID', condition_column=conditions_col_to_use, drug_column=drugs_col_to_use, color_code='#56B4E9', save_to="pdf")
...
plot_top_entities_side_by_side(clinical_df, id_column='nct_id', condition_column=conditions_col_to_use_clinical, drug_column=drugs_col_to_use_clinical, viz_name_suffix='clinical', save_to="pdf")
...
print("Unique entities in preclinical data:")
print(f"conditions: {preclinical_df[conditions_col_to_use].nunique()}")
print(f"drugs: {preclinical_df[drugs_col_to_use].nunique()}")
...
print("Unique entities in clinical data:")
print(f"conditions: {clinical_df[conditions_col_to_use_clinical].nunique()}")
print(f"drugs: {clinical_df[drugs_col_to_use_clinical].nunique()}")
...
print("Unique entity stats after merge:")
print(f"Unique disease entities after merge: {filtered_df['disease'].nunique()}")
print(f"Unique drug entities after merge: {filtered_df['drug'].nunique()}")
...
files_suffix = '_new_mappings'
# Export for manual review
output_path = f"{OUTPUT_DIR}condition_clinical_and_preclinical_{total}{files_suffix}.csv"
