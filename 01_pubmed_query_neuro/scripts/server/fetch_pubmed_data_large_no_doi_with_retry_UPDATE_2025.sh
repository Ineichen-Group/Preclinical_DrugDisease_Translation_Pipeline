...
#SBATCH --array=0-300%50                       # Array range, 50 tasks concurrently
...
# Input directory containing the PMID chunk files
...
CHUNK_FILE=$(printf "%s/pmid_chunk_%03d.txt" "$INPUT_DIR" "$SLURM_ARRAY_TASK_ID")
