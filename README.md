...
- [Large-Scale Assessment of Animal-to-Human Drug Translation Using Natural Language Processing](#large-scale-assessment-of-animal-to-human-drug-translation-using-natural-language-processing)
  - [Contents](#contents)
  - [PubMed Query](#pubmed-query)
    - [Setup](#setup)
    - [From query to PMIDs list](#from-query-to-pmids-list)
    - [From PMIDs to content](#from-pmids-to-content)
  - [Animal Studies Classification](#animal-studies-classification)
  ...
  - [Full-text retrieval and methods extraction](#full-text-retrieval-and-methods-extraction)
    - [Full-text retrieval](#full-text-retrieval)
      - [PMC](#pmc)
      - [Cadmus](#cadmus)
    - [Methods extraction](#methods-extraction)
      - [From PMC BioC fromat](#from-pmc-bioc-fromat)
      - [From Cadmus](#from-cadmus)
    - [Sentences extraction](#sentences-extraction)
  - [Full-text information extraction](#full-text-information-extraction)
    - [Snakemake pipeline](#snakemake-pipeline)
      - [Pipeline Steps](#pipeline-steps)
      - [Execution (Slurm Profile)](#execution-slurm-profile)
      - [Annotation and metadata aggregation](#annotation-and-metadata-aggregation)
  - [Trends in animal study characteristics](#trends-in-animal-study-characteristics)
  - [Animal-to-human translation analysis](#animal-to-human-translation-analysis)
    - [Drug-level translation proportions](#drug-level-translation-proportions)
      - [1. Preclinical linked entities](#1-preclinical-linked-entities)
      - [2. Clinical linked entities](#2-clinical-linked-entities)
      - [3. Clinical metadata (AACT)](#3-clinical-metadata-aact)
      - [4. FDA drug approval data](#4-fda-drug-approval-data)
    - [Drug\<\>Disease-level translation proportions](#drugdisease-level-translation-proportions)
      - [1. Preclinical publication metadata](#1-preclinical-publication-metadata)
      - [2. FDA drug–disease pair mapping](#2-fda-drugdisease-pair-mapping)
    - [Translation Table Preparation and Neuro Subsetting](#translation-table-preparation-and-neuro-subsetting)
      - [1. Merge Translation Tables](#1-merge-translation-tables)
      - [2. Neuro Filtering](#2-neuro-filtering)
    - [Descriptive Pair-Level Analysis of Animal Study Characteristics](#descriptive-pair-level-analysis-of-animal-study-characteristics)
      - [1. Load translation tables](#1-load-translation-tables)
      - [2. Define translation outcome](#2-define-translation-outcome)
      - [3. Identify relevant clinical timing](#3-identify-relevant-clinical-timing)
      - [4. Restrict to preclinical studies before clinical milestones](#4-restrict-to-preclinical-studies-before-clinical-milestones)
      - [5. Retrieve annotated preclinical studies](#5-retrieve-annotated-preclinical-studies)
      - [6. Build article-level and pair-level outputs](#6-build-article-level-and-pair-level-outputs)
      - [7. Derive experimental heterogeneity and rigor features](#7-derive-experimental-heterogeneity-and-rigor-features)
      - [8. Compare translated and non-translated pairs](#8-compare-translated-and-non-translated-pairs)
      - [9. Prepare association-analysis input](#9-prepare-association-analysis-input)
      - [10. Validation and visualization](#10-validation-and-visualization)
    - [Statistical Analysis of Translation-Associated Preclinical Study Features](#statistical-analysis-of-translation-associated-preclinical-study-features)
      - [Overview](#overview)
      - [Input](#input)
      - [Output](#output)
      - [Notes](#notes)
    - [Timeline of Preclinical Studies and Clinical Milestones](#timeline-of-preclinical-studies-and-clinical-milestones)
      - [Overview](#overview-1)
      - [Input](#input-1)
      - [Output](#output-1)
      - [Notes](#notes-1)
  - [Detailed docu of the IE modules is provided below.](#detailed-docu-of-the-ie-modules-is-provided-below)
    - [Regex-based extraction](#regex-based-extraction)
    - [Special Case: Assay/Readout Information Extraction](#special-case-assayreadout-information-extraction)
      - [Special Case: Age Information Extraction](#special-case-age-information-extraction)
    - [NER-based extraction](#ner-based-extraction)
      - [Animal Strain Normalization](#animal-strain-normalization)
      - [Animal Number Extraction](#animal-number-extraction)
    - [Document-Level Aggregation Script](#document-level-aggregation-script)
## PubMed Query
